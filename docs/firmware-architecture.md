...
The E290 library's 37-test host suite now qualifies that LoRa-first software
composition: 35 focused policy/product/credential-boot tests plus two cross-layer tests using
...
interrupted-initialization classifier now exist; integration still must compose
their explicit E290 boot/runtime states and same-boot ambiguous owner.
...
external serving lane. Credential integration next maps the implemented
interrupted-initialization classifier into E290 boot and retains live typed
...
initialization classifier pass portable gates; their E290 boot/runtime
composition, external API firmware/bearer composition, controlled peer RX/DATA,
...
3. Preserve the 37-test E290 host composition gate, including credential boot
   ...
   map their explicit E290 boot/runtime states and then compose ADR 0009's
