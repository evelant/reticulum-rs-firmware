...
gates and passes host composition tests; powered behavior remains unqualified.
...
build gates; pairing implementation, external API firmware/bearer composition,
powered HIL, multi-hop/Resource
