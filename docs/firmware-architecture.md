...
DATA packet during synchronous ingest. It has not yet composed the LXMF store,
retained-proof policy, delayed-proof capacity, or a ready-proof drain into the
ordinary router. Powered composition and remote durable-delivery semantics wait
for that explicit wiring and qualification.
