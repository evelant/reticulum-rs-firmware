...
exact first dispatch. It also preserves validated inbound non-binary/string
MessagePack values and their wire timestamp as lossless application events.
