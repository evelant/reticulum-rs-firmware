...
use reticulum_board_e290_radio::{
    E290_NA915_DEFAULT_CONFIGURATION, E290_NA915_DEFAULT_CONFIGURATION_FINGERPRINT,
...
use reticulum_radio_interface::{
    BoundedRxOutcome, CadObservation, LoRaProfile, PacketTxFault, PacketTxObservation,
...
// This scripted harness exercises the production LoRa actor in isolation. Keep
...
impl LiveNodeSystem {
    pub fn new() -> Self {
        ...
        let offline = supervisor
            .register_interface(
                ...
                config::interface_properties(
                    reticulum_board_e290_radio::E290_NA915_DEFAULT_PROFILE,
                ),
            )
        ...
        let dispatcher = SoleRadioTxDispatcher::new(
            ...
            ordinary_permit,
            frame_dispatcher,
            config::dispatcher_config(E290_NA915_DEFAULT_CONFIGURATION),
        );
