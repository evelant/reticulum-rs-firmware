//! Pure, allocation-free projection of product telemetry into device API types.
        ...
        .map(|((observed_at_us, outcome), family)| {
            ...
            match family {
                RadioTxDispatchFamily::Data => transmit
                    ...
                    .unwrap_or_else(|| {
                        DiagnosticLoraLastTx::data_without_evidence(age_ms, api_tx_outcome(outcome))
                    }),
...
#[cfg(test)]
mod tests {
    use reticulum_board_e290_radio::E290_NA915_DEFAULT_22_DBM_CONFIGURATION;
