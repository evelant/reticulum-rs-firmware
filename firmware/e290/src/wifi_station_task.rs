//! Wi-Fi station owner for the gateway profile.
//!
...
#![cfg(all(target_arch = "xtensa", feature = "gateway"))]
...
use reticulum_e290_firmware::wifi_station_profile::{
...
async fn maintain_connection(
    ...
    loop {
        ...
        info!("e290-wireless-diagnostic stage=wifi-dhcp status=START");
        publish(
            status,
            bootstrap,
