...
pub const LXMF_STORE_OFFSET: u32 = 0x0073_0000;
/// LXMF message-store partition length: exactly 4 MiB.
...
const _: () = assert!(NODE_JOURNAL_OFFSET + NODE_JOURNAL_LEN == LXMF_STORE_OFFSET);
