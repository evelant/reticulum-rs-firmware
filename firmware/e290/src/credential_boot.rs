...
mod tests {
    ...
    use reticulum_device_api_credential_store::{
        ...
        RETIREMENT_MARKER_OFFSET, SEMANTIC_FORMAT_VERSION, SNAPSHOT_DIGEST_OFFSET,
        SNAPSHOT_IMAGE_OFFSET, mount,
    };
    ...
    fn snapshot_bytes(
        ...
        prefix[10..12].copy_from_slice(&SEMANTIC_FORMAT_VERSION.to_le_bytes());
