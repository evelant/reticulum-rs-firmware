...
//!
//! This crate implements the transcript-bound BLE GATT session profile. It is
...
//! bearer driver, logical CBOR dispatch, flash owner, Reticulum identity key,
//! or radio capability.
//!
...
//! explicit without coupling the client to a bearer driver, allocator, or async
//! runtime.
//!
...
pub use protocol::{
    BLE_GATT_SESSION_SUITE, BearerBinding, ClientHello, DeviceId, HandshakeRecordError,
    PROTOCOL_MAJOR, PROTOCOL_MINOR, RECORD_KIND_CLIENT_HELLO, RECORD_KIND_CLIENT_PROOF,
    RECORD_KIND_CLOSE, RECORD_KIND_REQUEST, RECORD_KIND_RESPONSE, RECORD_KIND_SERVER_HELLO,
    RECORD_KIND_SERVER_PROOF, SERVER_FLAG_DEVICE_API, SERVER_FLAG_INTEGRITY_ONLY,
    SERVER_FLAG_LOCAL_API, ServerHello, SessionId, SessionSuite,
};
