...
const GOLDEN_CAPABILITIES_REQUEST: &[u8] = &[
    0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x01, 0x03, 0xa0,
];

fn golden_capabilities_response() -> Vec<u8> {
    let mut encoded = vec![
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x01, 0x03, 0xb0, 0x00,
        0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0xf4, 0x02, 0x00, 0x03,
    ];
...
fn exact_identity_summary_goldens_round_trip() {
    const REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x03, 0x03, 0xa0,
    ];
    const RESPONSE: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x03, 0x03, 0xa1, 0x00,
...
fn exact_identity_summary_with_lxmf_destination_golden_round_trip() {
    const RESPONSE: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x03, 0x03, 0xa2, 0x00,
        0x50, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d,
...
fn identity_summary_unknown_fields_are_skipped_but_required_field_is_strict() {
    const UNKNOWN_REQUEST_FIELD: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x03, 0x03, 0xa1, 0x18,
        0x63, 0x82, 0x01, 0x02,
    ];
...
fn exact_experimental_inbox_status_goldens_round_trip() {
    const REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x02, 0x03,
        0xa0,
    ];
    const RESPONSE: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x02, 0x03,
...
fn exact_experimental_inbox_peek_goldens_round_trip() {
    const REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x03, 0x03,
        0xa0,
    ];
    const RESPONSE: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x03, 0x03,
...
fn exact_experimental_lxmf_next_goldens_round_trip() {
    const REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x04, 0x03,
        0xa1, 0x00, 0x07,
    ];
    const RESPONSE: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x04, 0x03,
...
fn exact_experimental_lxmf_read_goldens_round_trip() {
    const REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x05, 0x03,
...
fn exact_basic_lxmf_send_goldens_are_source_free_and_borrowed() {
    const REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x09, 0x02, 0x19, 0xf0, 0x06, 0x03, 0xa5,
    ...
    const RESPONSE: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x09, 0x02, 0x19, 0xf0, 0x06, 0x03, 0xa2,
...
fn exact_nearby_lxmf_peer_goldens_use_complete_boot_scoped_cursors() {
    const FIRST_REQUEST: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x19, 0xf0, 0x07, 0x03,
        0xa0,
    ];
...
fn nearby_lxmf_peer_cursor_and_response_shapes_are_strict() {
    const ONLY_INCARNATION: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x01, 0x02, 0x19, 0xf0, 0x07, 0x03, 0xa1,
    ...
    const SHORT_INCARNATION: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x01, 0x02, 0x19, 0xf0, 0x07, 0x03, 0xa2,
...
fn exact_typed_error_response_golden_round_trip() {
    const GOLDEN: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x18, 0x2a, 0x02, 0x00, 0x03, 0xa2, 0x00,
        0x04, 0x01, 0x02,
    ];
    let envelope = ResponseEnvelope {
        version: ApiVersion::CURRENT,
...
fn unknown_envelope_version_and_body_fields_are_skipped() {
    ...
    let bytes = [
        0xa5, 0x00, 0xa3, 0x00, 0x01, 0x01, 0x05, 0x07, 0x82, 0x01, 0x02, 0x01, 0x18, 0x2a, 0x02,
...
fn exact_experimental_submit_golden_and_borrowed_payload() {
    const GOLDEN: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x09, 0x02, 0x19, 0xf0, 0x01, 0x03, 0xa3,
        0x00, 0x50, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c,
...
fn exact_experimental_submit_accepted_response_has_only_submission_id() {
    const GOLDEN: &[u8] = &[
        0xa4, 0x00, 0xa2, 0x00, 0x01, 0x01, 0x05, 0x01, 0x09, 0x02, 0x19, 0xf0, 0x01, 0x03, 0xa1,
