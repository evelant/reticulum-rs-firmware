...
///
/// Version 7 removes the product appliance label from network configuration.
pub const SEMANTIC_FORMAT_VERSION: u16 = 7;
...
const _: () = assert!(LORA_PROFILE_END < PROTECTED_SIZE);
