...
pub use embedded::{
    ...
    EmbeddedSendError, InboundData, InboundDataProjection, InboundProofEvidence,
    InboundProofPolicy, InboundProofPolicyError, IngressAnnounceEgress, IngressBroadcastPolicy,
    IngressBroadcastScope, IngressCounters, IngressDisposition, IngressDropReason, IngressMetadata,
    IngressObservation, IngressOrigin, IngressReport, IngressSignalObservation, InterfaceId,
    LINK_DATA_CONTEXT_NONE, LocalAnnounceTargetError, MAX_CHANNEL_PAYLOAD, MAX_DATA_PAYLOAD,
    MAX_DIRECT_LXMF_CONTENT_SIZE, MAX_DIRECT_LXMF_WIRE, MAX_LXMF_TIMESTAMP_UNIX_MS,
    MAX_OPPORTUNISTIC_LXMF_CARRIER, MAX_OPPORTUNISTIC_LXMF_CONTENT_SIZE, NodeActions, NodeRole,
    PathRequestBuildError, PrepareBasicLxmfError, PrepareDataError, PrepareDirectLxmfLinkDataError,
