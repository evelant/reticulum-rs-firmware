...
pub use embedded::{
    ...
    MAX_DATA_PAYLOAD, MAX_LXMF_TIMESTAMP_UNIX_MS, MAX_OPPORTUNISTIC_LXMF_CARRIER,
    MAX_OPPORTUNISTIC_LXMF_CONTENT_SIZE, NodeActions, NodeRole, PathRequestBuildError,
    PrepareBasicLxmfError, PrepareDataError, PrepareOpportunisticLxmfDataError, PreparedBasicLxmf,
