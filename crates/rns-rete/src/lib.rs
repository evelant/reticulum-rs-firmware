...
pub use embedded::{
    ...
    InboundProofPolicy, InboundProofPolicyError, IngressBroadcastPolicy, IngressBroadcastScope,
    IngressCounters, IngressDisposition, IngressDropReason, IngressEgressSet, IngressMetadata,
