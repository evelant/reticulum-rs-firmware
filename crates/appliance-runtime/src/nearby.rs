...
use reticulum_appliance_sync::LxmfSession;
...
pub(crate) fn read_nearby_peers(
    session: &mut (dyn LxmfSession<Error = reticulum_appliance_sync::DeviceSessionError> + Send),
...
mod tests {
    ...
    use reticulum_appliance_sync::{DeviceSessionError, InboxCursor, InboxSummary};
