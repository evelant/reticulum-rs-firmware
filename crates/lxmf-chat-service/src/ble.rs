...
#[cfg(any(target_os = "macos", test))]
use reticulum_e290_ble_api::BleConfig;
#[cfg(target_os = "macos")]
use reticulum_e290_ble_api::BleTransport;
#[cfg(target_os = "macos")]
use reticulum_lxmf_chat_app::DeviceClientSession;
#[cfg(target_os = "macos")]
use reticulum_lxmf_chat_runtime::ConnectionMetadata;
use reticulum_lxmf_chat_runtime::{
    ConnectFailure, ConnectedSession, ConnectionTransport, Connector,
};

#[cfg(target_os = "macos")]
use crate::serial::{HostRng, read_credential};
